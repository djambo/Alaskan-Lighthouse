...
function preload() {
	...
	volcanoHeightmap.src = "images/heightmap-lava2.jpg";
...
function setup() {
	...
	scene.add(seaMesh);
	    ...
	    // lava
		lavaShape = new THREE.PlaneGeometry(800,800,25,25);
	 ...
	 //    scene.add(lavaMesh);
	    ...
	    var data = getHeightData(volcanoHeightmap,0.10);
        //set height of vertices
	    for ( var i = 0; i<lavaShape.vertices.length; i++ ) {
